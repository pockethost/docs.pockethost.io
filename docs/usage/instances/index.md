...
![View of an instance in the Idle state](./instance-idle-screenshot.png)
...
![View of an instance showing the which version of PocketBase it is running](./instance-version-screenshot.png)
